...
const page = async ({ params }: { params: { slug: string } }) => {
  ...
  return (
    <div>
      ...
      <Image
        className={
          "items-center md:w-[150px] md:h-[150px] h-[100px] w-[100px] flex justify-center mx-auto rounded-full border-yellow-400 border-8"
        }
      ...
      <div className="mt-20 mx-auto max-w-[var(--max-width-2)]">
        <section className="mx-5 mb-[7vh]">
          {/* <h1 className="text-xs font-semibold">{data.posts.length}</h1> */}
